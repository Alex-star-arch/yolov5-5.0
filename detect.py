    ...
    for path, img, im0s, vid_cap in dataset:
                ...
                for i, det in enumerate(pred):  # detections per image
                    ...
                    if len(det):
                        ...
                        if a0 != 0:
                            cv2.imwrite(save_path + f'{num}_{res}.jpg', im0)
                            num = num+1
                        else:
                            im1 = cv2.imread('no.jpg', 1)
                            cv2.imwrite(save_path + f'{num}_{res}.jpg', im1)
                            num+=1
                        #*************************************************
...
if __name__ == '__main__':
    ...
    parser.add_argument('--conf-thres', type=float, default=0.45, help='object confidence threshold')#置信度阈值
    parser.add_argument('--iou-thres', type=float, default=0.2, help='IOU threshold for NMS')#做nms的iou阈值
